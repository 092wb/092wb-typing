      ...
      <ScrollArea.Viewport className="h-full w-full px-3">
        <div className={styles.tabContent}>
          <div className={styles.section}>
            ...
            <span className={styles.sectionDescription}>开启后，每次练习章节中字根会随机排序。下一章节生效。建议先固定练几遍后开启随机练。</span>
          ...
          <div className={styles.section}>
            <span className={styles.sectionLabel}>练习时展示上一个/下一个字根</span>
            <span className={styles.sectionDescription}>开启后，练习中会在上方展示上一个/下一个字根</span>
            <div className={styles.switchBlock}>
          ...
          <div className={styles.section}>
            ...
            开启后，输入时不区分大小写，如输入“h”和“H”都会被认为是正确的。
            </span>
            <div className={styles.switchBlock}>
          ...
          <div className={styles.section}>
            ...
            <span className={styles.sectionDescription}>开启后，可以通过「鼠标悬停」字根显示正确答案 </span>
            <div className={styles.switchBlock}>
